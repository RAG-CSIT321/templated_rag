...
export default function Rag() {
  ...
  const defaultResponses = {
    ...
    "What is the latest Iphone right now?":
      "Iphone 16, Iphone 16 pro and Iphone 16 promax",

    "Compare between Dell and Macbook? Which one is better?": "Lenovo",

    "Which laptop is the most suitable for Computer Science?": "Ofc Lenovo.",
  };
    ...
    <div className="container w-screen min-h-screen overflow-x-hidden bg-[#FFFFFF] text-white">
      {isResponseScreen ? (
        ...
        <div className="middle h-[80vh] flex items-center flex-col justify-center">
          <h1 className="text-4xl mb-2" style={{ color: "#FFB804" }}>
            Hello!
          </h1>
          <p className="text-2xl mb-6" style={{ color: "#BE8B52" }}>
            How can I help you today?
          </p>

          <div className="boxes mt-[30px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-4 w-full max-w-6xl">
            <Card
              text="Which gaming laptop should I buy?"
              onClick={() =>
                handlePresetQuestion("Which gaming laptop should I buy?")
              }
            />

            <Card
              text="What is the latest Iphone right now?"
              onClick={() =>
                handlePresetQuestion("What is the latest Iphone right now?")
              }
            />

            <Card
              text="Compare between Dell and Macbook? Which one is better?"
              onClick={() =>
